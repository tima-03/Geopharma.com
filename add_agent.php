           ...
           $wilaya = mysqli_real_escape_string($conn, $_POST['wilaya']); 
                if(isset($_POST['creat'])){
                    ...
                    if(mysqli_num_rows($result) > 0){  
                        ...
                        $insert = "INSERT INTO `pharmacier` (`name`, `email`, `phone`, `location`, `password`, `wilaya`, `commun`, `conferm`) VALUES ('$name', '$email', '$phone', '$location', '$pass', '$wilaya', '$commun', '2')";
             ...
             <form action="" class="creat" method="post">
                <input type="text" name="name"  placeholder="name agent_dsp" required="required">
